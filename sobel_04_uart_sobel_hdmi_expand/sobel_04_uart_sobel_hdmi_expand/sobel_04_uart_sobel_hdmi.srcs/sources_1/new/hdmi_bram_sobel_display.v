...
// ── Edge inverted color display ──
// Mapping: edge_inv = 255 - edge_pixel
// Original: strong edge ≈ 255 (white), no edge ≈ 0 (black) → 黑底白边
// Inverted: strong edge ≈ 0 (black), no edge ≈ 255 (white) → 白底黑边
...
// ── Edge inverted RGB output ──
// edge_inv = 255 - edge_pixel: white background, black edges
wire [7:0] edge_inv;
